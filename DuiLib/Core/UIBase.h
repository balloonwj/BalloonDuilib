...
#define DUITRACEMSG _T("")
    ...
    public:
        ...
        HWND GetHWND() const;
        //该方法使任何需要使用HWND的地方都可以使用CWindowWnd或其子类
        operator HWND() const;
    ...
    protected:
        ...
        //子类重写这个方法以处理自己的消息；没有处理的消息最好先调用
        //m_pm.MessageHandler(uMsg, wParam, lParam, lRes)处理
        //再调用该父类的HandleMessage处理
